        ...
        <form onSubmit={() => Submit()}>
            <div className="row">
                <div className="col">
                    ...
                    <input onChange={setNewName} type="text" className="form-control" aria-describedby="nameHelp" placeholder="Product name" required />
                </div>
                <div className="col">
                    <label>Price</label>
                    <input onChange={setNewPrice} type="double" className="form-control" placeholder="Price" required />
                </div>
                <div className="row">
                    <div className="col">
            ...
            <button type="submit" className="btn btn-primary" disabled={price === -1 || name === "" || categoryId === "" || sellerId === ""}>Submit</button>
        </form>
    );
